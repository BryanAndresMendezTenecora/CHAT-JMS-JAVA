...
public class JSMRemitente {
	public static void main(String[] args) {
		try {
			enviarMensaje("logicalTestQ");
	...
	public static void enviarMensaje(String logicalTestQ) throws NamingException, JMSException{
